...
def latexfitresults(filename,sampleList,exactRegionNames=False,dataname='obsData',showSum=False, doAsym=True):
  workspacename = 'w'
  ...
  regionCatList = [ 'channelCat==channelCat::' +region for region in regionFullNameList]
